        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-12">
            <div className="md:col-span-2">
              <h4 className="text-white text-lg font-semibold mb-4">EVCharge Ethiopia</h4>
              <p className="mb-6">Leading the electric vehicle revolution in Ethiopia with smart, sustainable charging solutions.</p>
              ...
              <div className="flex space-x-4">
                {['facebook', 'twitter', 'instagram', 'linkedin'].map((social) => (
                  <a 
                    key={social}
                    href="#" 
                    className="w-10 h-10 flex items-center justify-center bg-gray-800 rounded-full text-gray-400 hover:bg-green-500 hover:text-white transition"
                  >
            ...
            {[
              ...
              {
                title: "Support",
                links: ["Help Center", "Safety", "Community", "Accessibility"]
              },
              {
                title: "Legal",
                links: ["Cookies", "Privacy", "Terms", "Guidelines"]
              }
            ].map((column, index) => (
              <div key={index}>
          ...
          <div className="border-t border-gray-800 pt-8 text-sm text-center">
            <p>&copy; {new Date().getFullYear()} EVCharge Ethiopia. All rights reserved.</p>
          </div>
        </div>
